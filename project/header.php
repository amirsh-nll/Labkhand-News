<!DOCTYPE html>
	<head>
		<meta charset="utf-8">
		<title>خبرگزاری لبخند</title>
		<link rel="stylesheet" href="raw/css/layout.css" />
		<link rel="stylesheet" href="raw/css/font-awesome.css">
		<link rel="stylesheet" href="raw/fontawesome/css/fontawesome.min.css">
		<link rel="stylesheet" href="raw/fontawesome/css/all.min.css">
	...
	<body>
		<div class="main">
			...
			<div class="right">
				<div class="logo">
					<a href="index.php" title="خبرگزاری لبخند">
						<img src="raw/image/logo.png" title="خبرگزاری لبخند" alt="خبرگزاری لبخند" />
					</a>
				</div>

				<div class="category">
				<h3>خوش آمدید</h3>
				<p style="text-align:justify;font-size:11px;padding:7px;">خبرگزاری لبخند یک خبرگزاری خصوصی می باشد که سردبیر این خبرگزاری بر عهده ی مدیر آن می باشد.</p>
				</div>
