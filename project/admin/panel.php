...
<html>
	<head>
		<meta charset="utf-8"> 
		<title>پنل مدیریت|خبرگزاری لبخند</title>
	...
	<body>
		<div class="panel">
			<div class="panel_menu">
				<div class="menu_logo"><img src="../raw/image/logo.png" width="140" height="90" title="خبرگزاری لبخند" alt="خبرگزاری لبخند" /></div>
				<table>
					<tr>
						<td><span class="fa fa-lg fa-home"></span></td>
						<td><a href="panel.php?page=home" title="پیشخوان">پیشخوان</a></td>
					</tr>
					<tr>
						<td><span class="fa fa-lg fa-edit"></span></td>
						<td><a href="panel.php?page=new_post" title="ارسال مطلب جدید">ارسال مطلب جدید</a></td>
					</tr>
					<tr>
						<td><span class="fa fa-lg fa-database"></span></td>
						<td><a href="panel.php?page=list_post" title="لیست مطالب سایت">لیست مطالب سایت</a></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><a target="_blank" href="../index.php" title="مشاهده خبرگزاری لبخند">مشاهده خبرگزاری لبخند</a></td>
					</tr>
					<tr>
