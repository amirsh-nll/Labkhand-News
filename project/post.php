					...
					<?php
						...
						else
						{
							...
							else
							{
								...
								echo '<div class="content"><p><small>اشتراک گذاری در شبکه های اجتماعی :</small></p>';
								echo '<div class="socialmedia-icon"><a href="https://facebook.com" title="اشتراک گذاری با فیس بوک"><span class="fab fa-2x fa-facebook"></span></a>
								<a href="https://twitter.com/" title="اشتراک گذاری با توییتر"><span class="fab fa-2x fa-twitter"></span></a>
								<a href="https://telegram.org/" title="اشتراک گذاری با تلگرام"><span class="fab fa-2x fa-telegram"></span></a>
								<a href="https://www.linkedin.com/" title="اشتراک گذاری با لینکدین"><span class="fab fa-2x fa-linkedin"></span></a>
								<a href="https://vimeo.com/" title="اشتراک گذاری با ویمئو"><span class="fab fa-2x fa-vimeo"></span></a>
								<a href="https://www.whatsapp.com/" title="اشتراک گذاری با واتس اپ"><span class="fab fa-2x fa-whatsapp"></span></a>
								<a href="https://www.pinterest.com/" title="اشتراک گذاری با پینترست"><span class="fab fa-2x fa-pintrest"></span></a>
								<a href="https://plus.google.com/" title="اشتراک گذاری با گوگل پلاس"><span class="fab fa-2x fa-google-plus"></span></a>
								<a href="https://www.instagram.com/" title="اشتراک گذاری با اینستاگرام"><span class="fab fa-2x fa-instagram"></span></a></div></div>';
								...
								if($list_comment===0)
								{
									echo '<div style="border:20px solid #ffca28;color:#000;text-align:center;line-height:100px;font-family:tahoma;font-size:13px;">هیچ نظری موجود نیست.</div>';
								}
								else
								{
