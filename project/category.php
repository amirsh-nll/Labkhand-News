				...
				<div class="post">
					<?php
						...
						else
						{
							...
							if($category_post===0)
							{
								echo '<div style="border:20px solid #ffca28;color:#000;text-align:center;line-height:300px;font-family:tahoma;font-size:13px;">هیچ مطلبی در این دسته بندی موجود نیست.</div>';
							}
							else
							{
